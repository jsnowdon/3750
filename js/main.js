...
function searchBar() {
    var subject = $("#dropdownBtn").text();
    var searchTerm = $("#searchQuery").val();
    moveToSearchPage(subject,searchTerm);
}
